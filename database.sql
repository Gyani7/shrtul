...
BEGIN
  SELECT jsonb_build_object(
    ...
    'top_links', COALESCE((
      SELECT jsonb_agg(jsonb_build_object('alias', alias, 'url', destination_url, 'clicks', total_clicks) ORDER BY total_clicks DESC)
      FROM (
        SELECT alias, destination_url, total_clicks
